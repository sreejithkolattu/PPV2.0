jQuery.sap.declare("com.jabil.fi.util.messages");
jQuery.sap.require("sap.ca.ui.message.message");

com.jabil.fi.util.messages = {};
 ...
 * @public
 */
com.jabil.fi.util.messages.showErrorMessage = function(oParameter) {
	var oErrorDetails = com.jabil.fi.util.messages._parseError(oParameter);
...
com.jabil.fi.util.messages.getErrorContent = function(oParameter) {
	return com.jabil.fi.util.messages._parseError(oParameter).sMessage;
};

com.jabil.fi.util.messages._parseError = function(oParameter) {
	var sMessage = "",
		sDetails = "",
		oEvent = null,
		oResponse = null,
